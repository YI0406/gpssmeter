...
// Simple, production-ready-ish IAP wrapper for a one-time VIP unlock on iOS/Android
// Product (non‑consumable): com.GPSSmeter.vip
//
// What this does:
// 1) Queries product details.
// 2) Starts a purchase for VIP.
// 3) Listens to purchase updates and grants entitlement.
// 4) Persists VIP flag with SharedPreferences.
// 5) Exposes ValueNotifiers for UI (loading/errors/VIP state) so you can
//    hide ads and show a thank‑you dialog immediately after success.
//
// Usage (example):
//   final iap = PurchaseService.instance;
//   await iap.init();
//   // Show a Buy button only when iap.vipProduct != null and !iap.isVip.value
//   // To buy:
//   await iap.buyVip();
//   // To restore:
//   await iap.restore();
//   // React to VIP changes:
//   iap.isVip.addListener(() { /* hide banner ads, show thank-you, etc. */ });
//
// Notes:
// - This sample assumes a ONE‑TIME NON‑CONSUMABLE product.
// - No server-side receipt validation is included; you can add it later if needed.
// - On iOS, "Restore" is required to comply with App Review.
...
class PurchaseService {
  ...
  final String _productId = 'com.GPSSmeter.vip';
