// lib/ad.dart
// Interstitial ad manager for Google AdMob.
// Usage:
//  1) call `await AdService.instance.init(...)` once at app startup
//  2) call `AdService.instance.showInterstitial()` when you want to show it
//  3) the manager will auto-preload the next one after showing/dismiss
...
class AdService with WidgetsBindingObserver {
  ...
  static const String admobAppId = 'ca-app-pub-1219775982243471~1867218964';

  /// Interstitial Unit IDs
  static const String _prodInterstitialId =
      'ca-app-pub-1219775982243471/9266648096'; // 發布用（正式）
